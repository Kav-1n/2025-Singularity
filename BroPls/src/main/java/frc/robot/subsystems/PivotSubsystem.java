...
public class PivotSubsystem extends SubsystemBase {
    ...
    // Voltage control constant
    private static final double MAX_VOLTAGE = 12.0;
    
    // Manual control constants
    private static final double MANUAL_SPEED = 0.3; // Speed multiplier for manual control
    ...
    public PivotSubsystem() {
        ...
        TrapezoidProfile.Constraints m_constraints = new TrapezoidProfile.Constraints(3, 2);
    ...
    public void manualControl(double speed) {
        ...
        // Convert speed to voltage and apply to motor
        double voltage = speed * MAX_VOLTAGE;
    ...
    public void periodic() {
        if (isManualControl) {
            ...
            pivotMotor.setVoltage(0);  // Stop the motor if movement is not enabled
