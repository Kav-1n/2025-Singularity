...
public class PivotSubsystem extends SubsystemBase {
    ...
    private static final double MANUAL_SPEED = 0.3; // Reduced from 1.0 to make movement gentler
    ...
    public PivotSubsystem() {
        ...
        m_controller = new ProfiledPIDController(1, 0.03, 0.5, m_constraints);
        m_controller.reset(m_encoder.getPosition());
        
        // Holding controller with even gentler values
        m_holdController = new ProfiledPIDController(1, 0.05, 0.5, m_constraints);
